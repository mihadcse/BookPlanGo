...
/*ObservableList<String> locations= FXCollections.observableArrayList("Dhaka",
                ...
                "Khulna",
                "Sylhet");
        location_box.setItems(locations);*//*

    }

    private void initializeLocationBox() {
        ObservableList<String> locations = FXCollections.observableArrayList(
                "Dhaka", "Chattogram", "Sylhet", "Rajshahi", "Barishal", "Rangpur", "Khulna", "Sylhet");
        location_box.setItems(locations);
    }
...
/*String verifysignup = "INSERT INTO userinfo (NID, Username, Password, Contact) " +
        ...
        String verifysignup = "INSERT INTO userinfo (NID, Username, Password, Contact) " + "VALUES (" + Integer.parseInt(NID) + ", '" + username + "', '" + password + "', '" + phone_email_Text.getText() + "')";
    ...
    public void servicevalidateSignup() {
        ...
        String service_address = location_box.getValue() ;
        ...
        String verifysignup = "Insert into serviceprovider_info (service_id,service_name,service_password,service_phone_no,service_type,service_location) values ('"+S_ID+"','"+servicename+"','"+password+"','"+service_phone_Text.getText()+"','"+"Hotel"+"','"+service_address+"')";

        String verifysignup2 = "Insert into serviceprovider_info (service_id,service_name,service_password,service_phone_no,service_type,service_location) values ('"+S_ID+"','"+servicename+"','"+password+"','"+service_phone_Text.getText()+"','"+"Car"+"'"+service_address+"')";
