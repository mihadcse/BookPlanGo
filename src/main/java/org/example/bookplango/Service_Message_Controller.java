...
public class Service_Message_Controller {
    ...
    public void initialize() throws SQLException {
        ...
        String query_name = "Select service_name from sys.serviceprovider_info where service_id = '"+s+"'";
        Statement statement2 = connectDB.createStatement();
    ...
    public void click_message() throws SQLException {
        ...
        if(receiver_name.getText().equals("Admin")) {
            String query_insert1 = "INSERT INTO `sys`.`message`\n" +
                    "(`from_id`,\n" +
                    "`to_id`,\n" +
                    "`from_name`,\n" +
                    "`to_name`,\n" +
            ...
            String query_insert = "INSERT INTO `sys`.`message`\n" +
                    "(`from_id`,\n" +
                    "`to_id`,\n" +
                    "`from_name`,\n" +
                    "`to_name`,\n" +
